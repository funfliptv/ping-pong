...
var automationExtraPlugin = require('automation-extra-plugin');
...
const debug = Debug__default['default']('automation-extra:plugins');
class PluginList {
    constructor(env) {
        this.env = env;
        this._plugins = [];
...
const debug$1 = Debug__default['default']('automation-extra');
class AutomationExtraBase {
    constructor(driverName, _launcher) {
        this._launcher = _launcher;
        this.env = new automationExtraPlugin.LauncherEnv(driverName);
    ...
    use(plugin) {
        ...
        debug$1('Plugin registered', plugin.name); /* tslint:disable-line */
        return this;
    }
    /**
    ...
    async _bindPuppeteerBrowserEvents(browser) {
        debug$1('_bindPuppeteerBrowserEvents');
    ...
    async _bindPlaywrightBrowserEvents(browser) {
        debug$1('_bindPlaywrightBrowserEvents');
        browser.on('disconnected', () => {
            this.plugins.dispatch('onDisconnected', browser);
        });
    ...
    _requireLauncherOrThrow() {
        ...
        const launcher = requirePackages$1(packages);
        if (launcher) {
            return launcher;
        }
